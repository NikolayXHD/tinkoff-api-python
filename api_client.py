...
class ApiClient(object):
    ...
    def sanitize_for_serialization(self, obj):
        ...
        :rtype: The serialized form of data.
        """
        if obj is None:
            return None
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                if enum.Enum in klass.__bases__:
                    return klass(data)
    ...
    def parameters_to_tuples(self, params, collection_formats):
        ...
        :rtype: Parameters as list of tuples, collections formatted
        """
        new_params = []
    ...
    def prepare_post_parameters(self, post_params=None, files=None):
        ...
        :rtype: Form parameters with files.
        """
        params = []
    ...
    def select_header_accept(self, accepts):
        ...
        :rtype: Accept (e.g. application/json).
        """
        if not accepts:
            return
    ...
    def select_header_content_type(self, content_types):
        ...
        :rtype: Content-Type (e.g. application/json).
        """
