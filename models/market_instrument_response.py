...
class MarketInstrumentResponse(object):
    ...
    def __init__(self, tracking_id=None, status='Ok', payload=None):
        """MarketInstrumentResponse - a model defined in Swagger"""
    ...
    def tracking_id(self):
        """Gets the tracking_id of this MarketInstrumentResponse.

        :returns: The tracking_id of this MarketInstrumentResponse.
        :rtype: str
        """
    ...
    @property
    def status(self):
        """Gets the status of this MarketInstrumentResponse.

        :returns: The status of this MarketInstrumentResponse.
        :rtype: str
        """
        return self._status
    ...
    @property
    def payload(self):
        """Gets the payload of this MarketInstrumentResponse.

        :returns: The payload of this MarketInstrumentResponse.
        :rtype: clients.tinkoff.models.MarketInstrument
        """
