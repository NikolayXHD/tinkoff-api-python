...
class PlacedMarketOrder(object):
    ...
    @property
    def order_id(self):
        """Gets the order_id of this PlacedMarketOrder.

        :returns: The order_id of this PlacedMarketOrder.
        :rtype: str
        """
    ...
    @property
    def operation(self):
        """Gets the operation of this PlacedMarketOrder.

        :returns: The operation of this PlacedMarketOrder.
    ...
    @property
    def status(self):
        """Gets the status of this PlacedMarketOrder.

        :returns: The status of this PlacedMarketOrder.
    ...
    def reject_reason(self):
        """Gets the reject_reason of this PlacedMarketOrder.

        :returns: The reject_reason of this PlacedMarketOrder.
        :rtype: str
        """
    ...
    @property
    def message(self):
        """Gets the message of this PlacedMarketOrder.

        Сообщение об ошибке
        :returns: The message of this PlacedMarketOrder.
        :rtype: str
        """
    ...
    def requested_lots(self):
        """Gets the requested_lots of this PlacedMarketOrder.

        :returns: The requested_lots of this PlacedMarketOrder.
        :rtype: int
        """
    ...
    def executed_lots(self):
        """Gets the executed_lots of this PlacedMarketOrder.

        :returns: The executed_lots of this PlacedMarketOrder.
        :rtype: int
        """
    ...
    @property
    def commission(self):
        """Gets the commission of this PlacedMarketOrder.

        :returns: The commission of this PlacedMarketOrder.
