...
class PortfolioCurrenciesResponse(object):
    ...
    def __init__(self, tracking_id=None, status='Ok', payload=None):
        """PortfolioCurrenciesResponse - a model defined in Swagger"""
    ...
    def tracking_id(self):
        """Gets the tracking_id of this PortfolioCurrenciesResponse.

        :returns: The tracking_id of this PortfolioCurrenciesResponse.
        :rtype: str
        """
    ...
    @property
    def status(self):
        """Gets the status of this PortfolioCurrenciesResponse.

        :returns: The status of this PortfolioCurrenciesResponse.
        :rtype: str
        """
        return self._status
    ...
    @property
    def payload(self):
        """Gets the payload of this PortfolioCurrenciesResponse.

        :returns: The payload of this PortfolioCurrenciesResponse.
        :rtype: clients.tinkoff.models.Currencies
        """
