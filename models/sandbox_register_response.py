...
class SandboxRegisterResponse(object):
    ...
    def __init__(self, tracking_id=None, status='Ok', payload=None):
        """SandboxRegisterResponse - a model defined in Swagger"""
    ...
    def tracking_id(self):
        """Gets the tracking_id of this SandboxRegisterResponse.

        :returns: The tracking_id of this SandboxRegisterResponse.
        :rtype: str
        """
    ...
    @property
    def status(self):
        """Gets the status of this SandboxRegisterResponse.

        :returns: The status of this SandboxRegisterResponse.
        :rtype: str
        """
        return self._status
    ...
    @property
    def payload(self):
        """Gets the payload of this SandboxRegisterResponse.

        :returns: The payload of this SandboxRegisterResponse.
        :rtype: clients.tinkoff.models.SandboxAccount
        """
